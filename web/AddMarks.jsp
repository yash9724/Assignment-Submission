            ...
            <div class="col-xs-12">
                <div class="container-fluid">
                    <div class="jumbotron addUserJumbo">
                        ...
                        <form name="marksForm" id="marks-form" class="addUser" accept-charset="utf-8">
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" type="text" id="mid-1" required/>
                            </div>
                            <div class="form-group">
                                <label for="mid-2">Midsem-2</label>
                                <input class="form-control" type="text" id="mid-2" required/>
                            </div>
                            <div class="form-group">
                                <label for="mid-3">Midsem-3</label>
                                <input class="form-control" type="text" id="mid-3" required/>
                            </div>
                            
                        </form> 
                            <div>
                                <span id="markssaveresult"></span>
                                <button class="btn btn-primary btn-sm" onclick="saveStudentMarks()">Save</button>

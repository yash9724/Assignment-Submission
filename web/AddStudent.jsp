...
<body onload="document.studentForm.reset()">
    <%
                    ...
                    <div class="jumbotron addUserJumbo">
                        ...
                        <form name="studentForm" id="studentForm" class="addUser">
                            ...
                            <div>
                                ...
                                <button  class="btn btn-primary btn-sm" data-id="add" onclick="saveStudentDetails(event)">Save</button>
                                <button class="btn btn-primary btn-sm" onclick="document.studentForm.reset()">Discard</button>
                            </div>
                        </div>
                    </div>
                </div>

...
<head>
    ...
    <title>Site Administration | Mail</title>
...
<body onload="document.emailForm.reset()">
    ...
    <header id="header">
            <div class="row">
                <div class="col-md-10">
                    <h3 id="header-text"><span class="glyphicon glyphicon-envelope" aria-hidden="true"></span> &nbsp;Send Mail  <small>Manage Your Site</small></h3>
                </div>
            </div>
    </header>
